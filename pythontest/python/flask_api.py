...
# class arm(Resource):
#     def get(self):
#         data = pd.read_csv('arm.csv')  # read local CSV
#         return {'data': data.to_dict()}, 200  # return data dict and 200 OK
#
#     def post(self):
#         parser = reqparse.RequestParser()  # initialize parser
...
#         parser.add_argument('acc_x', required=True)
#         parser.add_argument('acc_y', required=True)
#         parser.add_argument('acc_z', required=True)
#         parser.add_argument('gyro_x', required=True)
#         parser.add_argument('gyro_x', required=True)
#         parser.add_argument('gyro_x', required=True)
#
#         args = parser.parse_args()  # parse arguments to dictionary
...
#
#             })
#             data = data.replace(data,new_data, ignore_index=True)
#
#             data.to_csv('locations.csv', index=False)  # save back to CSV
#             return {'data': data.to_dict()}, 200  # return data with 200 OK
#         else:
